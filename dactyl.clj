...
(def α (/ π 30))                        ; curvature of the columns
...
(defn column-offset [column] (cond
  ...
  (= column 6) [45 -7.5 1] 
  (= column 7) [44 -7.5 1]
  (= column 8) [43 -7.5 1]              ; original [0 -5.8 5.64]
  :else [0 0 0]))

(def thumb-offsets [-2 -2 2])
...
+(def fixed-x [0 0 0 0 0 0 0 0 0])  ; relative to the middle finger (moved 0 and 1 +6)
+(def fixed-z [12.1    8.3 0  5   10.7 14.5 25 30 30])
