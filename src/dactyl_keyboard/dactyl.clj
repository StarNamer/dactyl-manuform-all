...
(def α (/ π 13.75))                        ; curvature of the columns
(def β (/ π 36.33))                        ; curvature of the rows
(def centerrow (- nrows 2.8))             ; controls front-back tilt
(def centercol 2.2)                       ; controls left-right tilt / tenting (higher number is more tenting)
...
(def extra-width 1.966)                   ; extra space between the base of keys; original= 2
(def extra-height 0.375)                  ; original= 0.5

(def wall-z-offset -15)                 ; length of the first downward-sloping part of the wall (negative)
(def wall-xy-offset 5)                  ; offset in the x and/or y direction for the first downward-sloping part of the wall (negative)
(def wall-thickness 2.25)                  ; wall thickness parameter; originally 5
